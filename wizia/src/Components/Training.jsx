function Training() {
  ...
  return (
    <>
    <div className="bg-bg2 py-[32px] lg:py-[144px] mx-[48px] rounded-3xl flex flex-col px-[14px] md:px-0 md:items-center">
        <div>
        ...
        <div className="grid grid-cols-1  lg:grid-cols-2 text-teal-300 pt-[30px] lg:pt-[64px]">
      {/* Left Column */}
