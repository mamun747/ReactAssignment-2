...
function Training() {
  ...
  return (
    <>
    <div className="bg-bg2 py-[32px] md:py-[144px] mx-6 md:mx-8 lg:mx-[48px] rounded-3xl flex flex-col px-[14px] md:px-0 md:items-center relative overflow-hidden">
        <div className="z-20">
    ...
    <img src="/image4.png" className="absolute right-0 md:left-0 bg-bg2 bottom-0 overflow-hidden" alt="" />
    </div>
    <Testimonial/>
    </>
  )
